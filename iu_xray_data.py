...
from iu_xray.onto import Findings
...
def collate_fn(data):
    ...
    Returns:
        ...
        token_tensor: Dim [batch size, max_sentence_num + 1, max_word_num]
...
class IU_XRay_Dataset(DatasetBase):
    ...
    Args:
        ...
        device: device to transer the data to
    """
