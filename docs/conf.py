...
project = u'Petuum Medical Images'
copyright = u'2020, Petuum'
author = u'Petuum'
...
html_title = u'Petuum Medical Images v0.1'
...
# of the sidebar.
html_logo = '_static/img/Petuum.png'
